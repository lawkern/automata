...
compile:
	...
	$(CC) $(CFLAGS) ./build/sdl3.o ./src/rule110.s      -o ./build/rule110_asm      $(LDFLAGS)
	$(CC) $(CFLAGS) ./build/sdl3.o ./src/wireworld.s    -o ./build/wireworld_asm    $(LDFLAGS)
	$(CC) $(CFLAGS) ./build/sdl3.o ./src/langtons_ant.s -o ./build/langtons_ant_asm $(LDFLAGS)
